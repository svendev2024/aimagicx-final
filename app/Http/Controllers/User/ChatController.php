            ...
            if (config('settings.chat_feature_user') == 'allow') {
                if (config('settings.chats_access_user') != 'all' && config('settings.chats_access_user') != 'premium') {
                    if (is_null(auth()->user()->member_of)) {
                        if ($template->category == 'professional' && (config('settings.chats_access_user') != 'premium' || config('settings.chats_access_user') != 'professional' || config('settings.chats_access_user') != 'all')) {                       
                            $data['status'] = 'error';
                            ...
                            $data['message'] = __('This Ai chat assistant is not available for your account, subscribe to get a proper access');
                            return $data;
                        } else if(($template->category == 'standard' || $template->category == 'all') && (config('settings.chats_access_user') != 'premium' || config('settings.chats_access_user') != 'professional' || config('settings.chats_access_user') != 'standard' || config('settings.chats_access_user') != 'all')) {
                            $data['status'] = 'error';
                            $data['message'] = __('This Ai chat assistant is not available for your account, subscribe to get a proper access');
                            return $data;
                        }
