    ...
    msgHTML = `
      <div class="msg ${side}-msg">
        ...
        <div class="message-bubble" id="chat-bubble-${code}">
          <div class="msg-text" id="${code}">
            <img src="{{ URL::asset('/img/svgs/chat.svg') }}">
            <button class="copy-button fa-solid fa-copy" data-text="${text}">
              Copy
            </button>
          </div>
        </div>
...
// Add event listener for keydown event to disable copy button on Enter key press
document.addEventListener("keydown", (event) => {
  if (event.key === "Enter" && isInputElement(event)) {
